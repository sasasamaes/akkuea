    ...
    <div className={cn("flex", message.type === "sent" ? "justify-end" : "justify-start")}>
      <div className="flex flex-col space-y-1 max-w-[75%] sm:max-w-[70%]">
        <div className="flex items-end gap-2">
          {message.type === "received" && <Avatar name={message.sender} imageUrl={message.senderAvatar} size="sm" />}
          <div
            className={cn("px-3 py-2 rounded-lg", message.type === "sent" ? "bg-green-500 text-white" : "bg-gray-200")}
          >
            {message.mediaUrl && (
