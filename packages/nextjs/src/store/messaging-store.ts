...
interface MessagesState {
  ...
  addMessage: (conversationId: string, message: Omit<Message, "id" | "timestamp" | "senderAvatar">) => void
  selectConversation: (conversationId: string) => void
  markConversationAsRead: (conversationId: string) => void
  setTypingStatus: (conversationId: string, isTyping: boolean) => void
  addConversation: (conversation: Omit<Conversation, "id" | "timestamp" | "lastMessage" | "unread">) => void
}
