...
describe('WebhookService', () => {
    ...
    describe('processTransactionWebhook', () => {
        ...
        it('should throw NOT_FOUND for unknown transaction', async () => {
            ...
            expect(webhookService.processTransactionWebhook(payload)).rejects.toThrow('Transaction with hash unknown-hash not found');
        });
        ...
        it('should throw CONFLICT for duplicate status update', async () => {
            ...
            expect(webhookService.processTransactionWebhook(payload)).rejects.toThrow('Transaction status is already confirmed');
        });
    });
});
